...
export class Header {
    ...
    private drawNav():void {
        ...
        const nav__garage_btn = createAndAppendHtmlElement( header__nav, "button", "nav__garage_btn", "TO GARAGE" ) as HTMLButtonElement;
        nav__garage_btn.disabled = true;
        ...
        this.BUTTONS.garage_btn =  nav__garage_btn;
